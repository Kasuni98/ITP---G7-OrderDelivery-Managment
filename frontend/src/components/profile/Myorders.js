                    ...
                    <div class="container"> <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#mynav" aria-controls="mynav" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button> <a class="navbar-brand" href="#">
                        ...
                        <div class="collapse navbar-collapse" id="mynav">
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                ...
                                <img src="https://www.freepnglogos.com/uploads/shopping-cart-png/shopping-cart-donations-shopping-carts-forms-membershipworks-21.png" width="80" alt="shopping cart, donations shopping carts forms membershipworks" />
                                <li class="nav-item"> <a class="nav-link" href="#"> <span class="fas fa-user pe-2"></span> Hello Kasuni!</a> </li>
                                <img src="https://www.freepnglogos.com/uploads/arrow-png/arrow-brushes-design-png-34.png" width="80" alt="brushes arrow png download" />
                            </ul>
                        </div>
                    </div>
                </nav>
                <div class="container mt-4">
                    <div class="row">
                        <div class="col-lg-3 my-lg-0 my-md-1">
                            <div id="sidebar" class="bg-purple"><img src="https://www.freepnglogos.com/uploads/computer-png/computer-png-cool-electronics-and-electronic-reviews-33.png" width="100" alt="computer png cool electronics and electronic reviews" />
                        ...
                        <div class="col-lg-9 my-lg-0 my-1">
                            <div id="main-content" class="bg-white border">
                                ...
                                <div class="text-uppercase">My recent orders</div><br></br><br></br>
